    ...
    <section class="room-details">
        <div class="room-details-container">
            <div class="room-info">
                <div>
                    <div class="slideshow-container">
                        <div class="mySlides fade">
                          ...
                          <img src="../images/double.jpg" style="width:100%">
                        </div>
                ...
                <div class="overview">
                    <h1>Overview</h1>
                    <p>Our Twin Room offers a stunning view of the white sand beach. This room is designed and decorated with modern style and equipped with the most luxurious facilites. Little luxuries include free Wi-Fi, deluxe bath amenities and a 4K technology flat-screen television with cable channels.</p>
                </div>
